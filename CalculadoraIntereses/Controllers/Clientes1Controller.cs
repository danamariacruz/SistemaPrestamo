...
namespace CalculadoraIntereses.Controllers
{
    public class Clientes1Controller : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ClienteID,Nombre,Apellido,Telefono,Correo,Direccion")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ClienteID,Nombre,Apellido,Telefono,Correo,Direccion")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
